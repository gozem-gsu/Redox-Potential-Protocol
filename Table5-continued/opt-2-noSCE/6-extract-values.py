        ...
        with open(csv_file_path, "w", newline="") as csvfile:
            ...
            writer.writerow(
                [
                    "Protonation State",
                    "SCFE(g)",
                    "Thermal Correction to Gibss Free Energy",
                    "SCFE(sol)",
                ]
            )
            ...
            for subdir in ["radical", "neutral", "anion"]:
                log_file_name = (
                    f"{folder}-an.log"
                    if subdir == "anion"
                    else f"{folder}-rad.log" if subdir == "radical" else f"{folder}.log"
                )
                ...
                PCM_log_file_name = (
                    ...
                    if subdir == "anion"
                        ...
                        f"{folder}-rad-PCM.log"
                        if subdir == "radical"
                        else f"{folder}-PCM.log"
                    )
                )
                ...
                if os.path.exists(log_file_path):
                    ...
                    thermal_correction_value = extract_last_thermal_correction(
                        log_file_path
                    )
