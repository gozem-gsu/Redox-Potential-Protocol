...
for i in {061..115}; do mkdir $i; done

for i in {061..115}; do    
    mkdir $i/neutral/
    cat top-0 xyz-opt/$i-opt.xyz >$i/neutral/$i.com
...
for i in {061..115}; do
    mkdir $i/radical/
    cat top-1 xyz-opt/$i-opt-rad.xyz >$i/radical/$i-rad.com
...
for i in {061..115}; do
    mkdir $i/anion/
    cat top-2 xyz-opt/$i-opt-an.xyz >$i/anion/$i-an.com
